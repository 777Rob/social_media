...
import AdvertismentProfileCreation from "components/Account/Rewards";

// @Description: Rewards page used to display the rewards of the user and the rewards that the user can redeem
// TODO: FINISH CONTRACTS AND CONNECT EVERYTHING TO THE REWARDS PAGE
const Dashboard = () => {
	return (
		<div style={{ display: "grid", gap: "10px", padding: "20px 10px" }}>
			...
			<Widget
				info="369.42 UAT"
				title="Rewards received for publishing content"
			/>
