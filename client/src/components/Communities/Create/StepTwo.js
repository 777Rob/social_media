  ...
  return (
    <Box sx={{spacing: "20px"}}>
      ...
      <TextInput
        ...
        onChange={(e) => {
          dispatch(SET_COMMUNITY_DETAILS({ ...form, description: e.target.value }));
      ...
      <TextInput
        ...
        onChange={(e) => {
          dispatch(SET_COMMUNITY_DETAILS({ ...form, memberLimit: e.target.value }));
      ...
      {state.membershipType !== 3 && <>
        <TextInput
          ...
          onChange={(e) => {
            dispatch(SET_COMMUNITY_DETAILS({ ...form, beneficiary: e.target.value }));
          ...
          required />
        <Button onClick={() => {
          dispatch(SET_COMMUNITY_DETAILS({ ...form, beneficiary: account }));

        }}>Set to your address</Button>
      </>}

      {/* If one time fee ask for fee*/}
      {state.membershipType === 2 && (<TextInput
        placeholder="Membership price MATIC"
        label="Membership price MATIC"
        name="Membership price MATIC"
        value={form.price}
        onChange={(e) => {
          dispatch(SET_COMMUNITY_DETAILS({ ...form, period: parseInt(e.target.value) }));
        }}
        variant="filled"
        radius="md"
        size="md"
      ...
      {state.membershipType === 1 && <TextInput
      ...
      {state.membershipType  === 1 && <TextInput
        ...
        value={form.price}
        onChange={(e) => {
          dispatch(SET_COMMUNITY_DETAILS({ ...form, price: parseInt(e.target.value) }));
        }}
        variant="filled"
        radius="md"
        size="md"
